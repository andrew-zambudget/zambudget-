...
| `bb_browser_access_token_<userId>` | localStorage | Auth or sync helper | Random browser access token | Not a budget decryptor. Used for browser-access registry hashing. |
