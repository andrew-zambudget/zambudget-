...
Use this gate before shipping any major change, release candidate, billing/account change, Cloud Sync change, privacy/security change, data-retention change, or user-visible workflow change.
...
- Related to billing, privacy, security, Cloud Sync, account deletion, login, data migration, or deployment behavior.
